          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _context.next = _context.t0 === 'email' ? 10 : _context.t0 === 'password' ? 12 : 14;
                break;
              ...
              case 21:
                ...
                return _context.abrupt("return", res.status(400).json({
                  status: 'error',
                  message: String(_context.t1.details[0].message),
                  type: 'validation'
                }));
...
var UserMiddleware = new UsersMiddleware();
