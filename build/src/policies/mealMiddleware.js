...
/*#__PURE__*/
function () {
  function MealsMiddleware() {
    _classCallCheck(this, MealsMiddleware);
  }

  _createClass(MealsMiddleware, [{
    ...
    value: function () {
      ...
      function validateAddMealToMenu(_x, _x2, _x3) {
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee2(req, res, next) {
        var schema, allowedImages, message;
      ...
      function validateAddMeal(_x4, _x5, _x6) {
    ...
    value: function () {
      ...
      function validateUpdateMeal(_x7, _x8, _x9) {
  ...
  return MealsMiddleware;
}();

var MealMiddleware = new MealsMiddleware();
